...
public class Amazon {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.navigate().to("https://www.amazon.in/gift-card-store/b/?ie=UTF8&node=3704982031&ref_=nav_cs_gc");
		List<WebElement>checkboxes=driver.findElements(By.xpath("//span[text()='Occasion']//parent::div//parent::div//input[@type='checkbox']//parent::label"));
